                    ...
                    <div key={category} className="relative w-full bg-zinc-50 p-5 rounded-lg shadow">
                        ...
                        >
                            {products.map((product) => (
                                <SwiperSlide key={product.id} className="bg-green-100 shadow-md rounded-lg p-4 relative">
                                    <div
                                    ...
                                    >
                                        ...
                                        >
                                            <button
                                                ...
                                                className="px-4 py-2 text-sm text-black border-black bg-zinc-100 rounded-md shadow-lg transition hover:bg-green-500 hover:text-white"
                                            >
                                                View Details
                                            </button>
                                        </div>
