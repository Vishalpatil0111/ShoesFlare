    ...
    return (
        <header className="w-full bg-gray-800 flex-col flex shadow-sm">
            ...
            <nav className="py-3 px-6 flex justify-between items-center">
                ...
                <div className="gap-4 w-1/2 text-white  hidden md:flex space-x-6 font-medium">
                    ...
                    <Link to="/kids" className="hover:text-yellow-600">For Kids</Link>
                    <Link to="/brands" className="hover:text-yellow-600">Brands</Link>
                    <Link to="/info" className="hover:text-yellow-600">More Info</Link>
                </div>

                <div className="flex space-x-4">
                    <FaSearch className="text-white hover:text-black cursor-pointer" />
